Write-Output "Creating scheduled task for r3dupdate..."
$Title = "r3dupdate"
...
$Action   = New-ScheduledTaskAction -Execute "r3dupdate.exe" -Argument "/Scheduled" -WorkingDirectory "$PSScriptRoot"
